...
class HeladeriaPOS:
    def __init__(self, root):
        ...
        # Configurar el grid principal para que sea adaptable
    ...
    def mostrar_pedidos(self):
        ...
        screen_height = self.root.winfo_screenheight()
         ...
         # Crear marco principal con configuración de grid
        ...
        pedido_frame.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")
        pedido_frame.grid_columnconfigure(0, weight=1)
        pedido_frame.grid_rowconfigure(1, weight=1)

        # Frame derecho para stock
        stock_frame = ttk.LabelFrame(self.main_frame, text="Stock Actual", padding="10")
        stock_frame.grid(row=0, column=1, padx=5, pady=5, sticky="nsew")
        stock_frame.grid_columnconfigure(0, weight=1)
        stock_frame.grid_rowconfigure(0, weight=1)

        # Configurar el Treeview de stock para que sea adaptable
        ...
        stock_scroll = ttk.Scrollbar(stock_frame, orient="vertical", command=stock_tree.yview)
        ...
        stock_tree.column('Producto', width=int(screen_width * 0.15))
        stock_tree.column('Stock', width=int(screen_width * 0.1))
        stock_tree.column('Precio', width=int(screen_width * 0.1))
    ...
    def mostrar_ayuda(self):
        ...
        help_frame = ttk.LabelFrame(self.main_frame, text="Guía de Usuario", padding="10")
        help_frame.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")
        
        # Configurar grid del help_frame
        help_frame.grid_columnconfigure(0, weight=1)
        help_frame.grid_rowconfigure(0, weight=1)

        # Crear frame para el texto con scrollbar
        text_frame = ttk.Frame(help_frame)
        text_frame.grid(row=0, column=0, sticky="nsew")
        text_frame.grid_columnconfigure(0, weight=1)
        text_frame.grid_rowconfigure(0, weight=1)

        # Configurar el widget Text para que sea adaptable
        help_text = tk.Text(text_frame, wrap=tk.WORD, font=('Arial', 12))
